...
Saka Krib <span className="font-normal text-gray-400">|</span> <span className="font-normal text-gray-500 dark:text-gray-400">Find Your Next Home, Effortlessly</span>
              </h1>
            </div>
            ...
            <div className="flex lg:flex-row gap-2 sm:flex-row sm:items-center">
              <div className="relative">
                ...
                <select
                  ...
                  className="h-9 rounded-full border border-gray-300 bg-gray-50 pl-8 pr-3 text-sm text-gray-700 dark:border-brand-700 dark:bg-brand-800 dark:text-gray-200"
                >
                ...
                {(['rent', 'sale'] as const).map((t) => (
                  <button
                    ...
                    className={cn(
                      ...
                      searchType === t
                        ? 'border-btnblue-500 bg-btnblue-500 text-white'
                        : 'border-gray-300 bg-white text-gray-600 dark:border-brand-700 dark:bg-brand-800 dark:text-gray-400'
                    )}
                  >
                    {t === 'rent' ? 'Rent' : 'Buy'}
                  </button>
              ...
              <button onClick={handleSearch} className="btn-primary h-9 text-sm">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {featured.map((listing) => (
              <button
                ...
                className="card group overflow-hidden text-left transition-all hover:shadow-md"
              >
      ...
      <section className="mx-auto max-w-7xl px-4 pb-8 sm:px-6 lg:px-8">
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ...
            { icon: TrendingUp, title: 'Free to Start', desc: '3 free listings for landlords. Browse free for renters.' },
            { icon: Users, title: 'Community Feed', desc: 'LinkedIn-style feed with AI-generated captions.' },
          ].map((item, i) => (
            <div key={i} className="card p-5">
              ...
              <h3 className="mt-3 text-base font-bold text-gray-900 dark:text-white">{item.title}</h3>
