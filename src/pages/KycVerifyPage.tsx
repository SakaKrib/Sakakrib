...
export default function KycVerifyPage() {
  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      const result =
        await protectedUpload<{
          path?: string;
          document_type?: string;
          size?: number;
          mime_type?: string;
        }>(
          '/api/accounts/kyc/upload/',
          formData
        );
      ...
      if (!uploadedPath) {
        throw new Error(
          'The document upload completed without a storage path. Please try again.'
        );
      }
