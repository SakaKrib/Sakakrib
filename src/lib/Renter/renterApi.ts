...
export interface MovingScheduleResponse { booking_id: string; schedule_id: string; starts_at: string; ends_at: string; status: string; }
...
export const renterApi = {
  ...
  proposeMoverSchedule: (bookingId: string, startsAt: string, endsAt: string) =>
    protectedPost<MovingScheduleResponse>(`/api/core/bookings/${encodeURIComponent(bookingId)}/schedule/propose/`, {
      starts_at: startsAt,
      ends_at: endsAt,
    }),

  confirmMoverSchedule: (bookingId: string) =>
    protectedPost<MovingScheduleResponse>(`/api/core/bookings/${encodeURIComponent(bookingId)}/schedule/confirm/`, {}),
