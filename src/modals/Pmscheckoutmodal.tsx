...
// // FIX: confirmed against the real _Landlordpms.tsx that this module
// // actually lives at lib/LandlordTs/LandlordpmsService, not lib/pmsService
// // (the path I'd originally guessed from the first, evidently-stale
// // file dump). getCurrentRealEstateSubscription's path below is NOT
// // re-confirmed the same way - no real real-estate-side consuming
// // file has been uploaded yet, so this import is still a guess carried
// // over from the original dump. Verify it before relying on the
// // PayPal/real-estate branch of this modal.
// import { getMyPMSSubscription } from '@/lib/LandlordTs/LandlordpmsService';
// import { getCurrentRealEstateSubscription } from '@/lib/Realestateservice';
// import {
...
// // state comes from the subscription record itself (via the same
// // get-my-subscription reads used elsewhere), because a PayPal
...
//     >
//       <div className="relative w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-brand-900">
//         <div className="flex items-start justify-between border-b p-5 dark:border-brand-700">
//           <div>
...
//             type="button"
//             onClick={handleClose}
//             className="rounded-lg p-2 text-gray-500 transition hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-brand-800"
//             aria-label="Close"
//           >
//             <X className="h-5 w-5" />
//           </button>
...
//               {error && (
//                 <div className="flex items-start gap-2 rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-700 dark:border-red-900 dark:bg-red-900/20 dark:text-red-400">
...
//                 className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gray-900 px-5 py-3 text-sm font-semibold text-white transition hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-50"
//               >
//                 {starting ? (
//                   <>
