    ...
    ">
      ...
      ">
        ...
        <p style="
          ...
          color:#444444;
        ">
          We wanted to let you know that your application
          to become a <strong>${role}</strong> on Saka Krib
        ...
        ">
          ...
          <p style="
            ...
            line-height:1.7;
          ">
            <strong>Please do not submit another application.</strong>
            Your current application is already being reviewed.
