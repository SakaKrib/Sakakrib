    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                ...
                name='listing_payments_amount_check',
            ),
        ),
        migrations.AddConstraint(
            model_name='listingpayment',
            constraint=models.CheckConstraint(
                ...
                name='listing_payments_amount_fixed_check',
            ),
        ),
        migrations.AddConstraint(
            model_name='listingpayment',
            constraint=models.CheckConstraint(
                condition=models.Q(status__in=['PENDING', 'PAID', 'FAILED', 'CANCELLED']),
                name='listing_payments_status_check',
            ),
        ),
        migrations.AddConstraint(
            model_name='listingpayment',
            constraint=models.CheckConstraint(
                ...
                name='listing_payments_provider_check',
            ),
        ),
        migrations.AddConstraint(
            model_name='listingpayment',
            constraint=models.CheckConstraint(
                condition=models.Q(payment_method__isnull=True) | models.Q(payment_method__in=['MPESA', 'PAYPAL']),
                name='listing_payments_method_check',
            ),
        ),
        migrations.AddConstraint(
            model_name='listingpayment',
