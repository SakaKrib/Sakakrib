...
PAYPAL_SUBSCRIPTION_RETURN_URL = os.getenv('PAYPAL_SUBSCRIPTION_RETURN_URL', 'http://localhost:5173/paypal/subscription/return')
PAYPAL_SUBSCRIPTION_CANCEL_URL = os.getenv('PAYPAL_SUBSCRIPTION_CANCEL_URL', 'http://localhost:5173/paypal/subscription/cancel')
