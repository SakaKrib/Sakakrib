...
INSTALLED_APPS = [
    'django.contrib.contenttypes', 'django.contrib.auth', 'django.contrib.sessions', 'django.contrib.messages',
    'django.contrib.staticfiles', 'corsheaders', 'rest_framework', 'apps.core', 'apps.accounts',
    'apps.listings', 'apps.subscriptions', 'apps.payments',
]
...
REST_FRAMEWORK = {'DEFAULT_AUTHENTICATION_CLASSES': ['apps.accounts.authentication.SupabaseJWTAuthentication'],
...
# Business rules are configuration, not hard-coded application logic.
