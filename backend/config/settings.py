...
# Django owns authentication and the application database. Supabase is not
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'sakakrib'),
        'USER': os.getenv('DB_USER', 'sakakrib'),
...
# Email transport is configured exclusively through environment variables.
